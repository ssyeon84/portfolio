    ...
    return (
        <Fragment>
            <nav className="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
                ...
                <a className="navbar-brand" href="#page-top">SEO YEON, SONG</a>
                ...
                <div className="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li className="nav-item mx-0 mx-lg-1"><a className="nav-link py-3 px-0 px-lg-3 rounded" href="#stacks">Stacks</a></li>
